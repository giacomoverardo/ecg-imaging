...
def get_last_number_in_string(in_string:str)->int:
    """Extract last number at the end of the string

    Args:
        in_string (str): input string

    Returns:
        int: integer number at the end of the string
    """
    return int(re.search(r'\d+$', in_string).group())
